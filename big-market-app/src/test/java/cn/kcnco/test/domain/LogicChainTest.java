...
import cn.kcnco.domain.strategy.service.rule.chain.impl.RuleWeightLogicChain;
...
public class LogicChainTest {
    ...
    public void test_LogicChain_rule_weight() {
        ...
        DefaultChainFactory.StrategyAwardVO strategyAwardVO = logicChain.logic("KCNCO", 100001L);
        log.info("测试结果：{}", JSON.toJSONString(strategyAwardVO));
    }
